...
<!-- Tabla de comentarios administrativos -->
          ...
          <table class="table table-hover" style=" position: absolute;  left: 100px; top:90px;  width: 600px;" >
           <thead >
               <tr style="background-color:#00b3b3; width: 600px; font-size:20px; font-family: Times New Roman, Times, serif; border-color:#000000;">

                 <th >#</th>
                 <th style=" position: absolute; background-color:#00b3b3; left: 100px; width: 350px; ">Comentarios Administrativos</th>
                  <th style= " background-color:#00b3b3f; position: absolute;  left: 450px; width: 150px;">Accion</th>
    ...
    <tr style="height: 80px;  background-color:#b3cccc; font-size:20px; font-family: Times New Roman, Times, serif;">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document" >
          <div class="modal-content" style="position:absolute; left:50px; top:100px;">
              ...
              <form method="POST" action="{{route('comentario.update',['id'=>$pacientes->id,'id2'=>$ver->id])}}">
               ...
               <div>
       <button type="submit" class="btn btn-primary" style="border-color:#ff8533; background-color:#ff8533; color:white;  position: absolute;
       left: 390px;top:  95px; " >Guardar </button>
       </div>

              </form>
              </div>
              <div class="modal-footer" style=" color:white;  height:80px; " >

                  <button type="button" class="btn btn-secondary" data-dismiss="modal"  style="background-color:#b37700; color:white; position: absolute;
                   left: 300px;top:  170px;">Cerrar</button>
      ...
      <div class="modal-dialog" role="document" style="background-color:#f2e6ff;  position: absolute; left: 480px; top:190px; ">
          <div class="modal-content">
              ...
              <div class="modal-footer" style=" width: 500px;height: 80px;">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal"  style="background-color:#ff704d;  position: absolute;left: 300px;top:155px;">Cerrar</button>
                  <form method="post" action="{{route('comentario.borrar',['id'=>$ver->id])}}">
                      @csrf
                      @method('delete')
                      <input type="submit" value="Eliminar" class="btn btn-danger"  style="background-color:#ff5050;  position: absolute; left: 380px;top:160px;">
                  </form>
              </div>
          </div>
      </div>
...
@can('create',App\Comentario::class)
<button style="  position: absolute;left: 950px;top:250px; border-color:#00cc99; background-color:#ffb366; color:#1a001a; " type="button" data-toggle="modal" data-target="#create" class="btn btn-secondary">
