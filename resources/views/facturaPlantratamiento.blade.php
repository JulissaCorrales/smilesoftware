...
<body>
    <div id="padre" class="card">
           ...
           <h2 id="titempresa"align="center">
            @forelse($logotipos  as $tag)
            <img align="center"style="margin-left:10px; " class="logo" id="imlogoactual"src="{{Storage::url($tag->logo)}}" class="mr-3"  width="80px" high="100px" >
            @empty
            <img class="logo" style="margin: left 5px;  "  src="{{ asset('Imagenes/logo4.jpg') }}" class="mr-3" width="100px" high="100px"> 
            @endforelse
            
            </h2> </div>
           
                  <div>  <h2 ><svg width="2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-card-checklist" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- descargar -->
                    <a type="btn" style="float:right;margin-top:-4em;"class="btn btn-warning"href="{{route('descargarPDFfacturaplan',['id'=>$pacientes->id,'id2'=>$plantratamientos->id])}}"class="dropdown-item"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-cloud-download" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="btn btn-outline-dark"href='{{route('tratamiento.ver',['id'=>$pacientes->id])}}'
        >
