  ...
  <path d="M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1z"/>
            ...
            <p>En esta Sección se muestra la agenda de la clínica, se pueden agregar nuevas citas asi como verlas por semana o mes, y descargar las citas Existentes</p>
                  ...
                  @can('view', App\Cita::class)
                      <a type="button" class="btn btn-outline-info" href="/pantallainicio/calendario/citadiaria" style=" background-image: linear-gradient(to bottom, #1687a7); "><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-calendar-day" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  @can('create', App\Cita::class)
                    <a type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#create" style=" background-image: linear-gradient(to bottom, #1687a7);"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-calendar3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
