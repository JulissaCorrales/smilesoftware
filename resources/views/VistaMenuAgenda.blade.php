...
<nav class="navbar navbar-light bg-light"  id="navasdeBotones" >
  <h5>Agenda</h5>
  <button type="button" class="btn btn-outline-info" id="diaria"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-calendar-day" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
