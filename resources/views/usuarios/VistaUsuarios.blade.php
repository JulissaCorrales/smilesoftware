...
<div class="card mb-3">
          <div class="card-header">
           <h4><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-badge-fill" viewBox="0 0 16 16">
            ...
            @can('$nuevo', App\Usuario::class)<!-- boton de nuevo usuario -->
            <div>
                <a type="button"style="background-color:#28a4a4; color:#c1f0f0; position: absolute;
                            left: 100px;
                            top:  85px;"  class="btn" href="/pantallainicio/{{$usuario->id}}/editar"><svg width="25" height="25" viewBox="0 0 16 16" class="bi bi-cloud-download" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
