...
<textarea required id="w3review" maxlength="255" placeholder="Escriba la evolución del plan de tratamiento" name="caja" value="text" rows="4" cols="52" ></textarea>
</div>
...
<div id="disv4"  style="margin:2em;margin-left:10%;">
  ...
  todavia no tiene una evolución de algun plan de tratamiento.
  @endforelse
  </select>
</div>
<div id="disv4">
...
<!--button de editar evolucion -->
  @can('update',$tag)
      <button type="button"  class="btn btn-outline-success" data-toggle="modal" data-target="#modaleditar-{{$tag->id}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
