     ...
     <!-- Este codigo es para la ventana modal gasto nuevo -->
        <div class="modal fade" id="creategasto" >
            ...
            <option value="Materias Primas">Materias Primas</option>
                    ...
                    <input  required type="number" min="1" pattern="^[0-9]+" class="form-control custom-select" name="monto" id="monto" placeholder="Ingrese el monto del gasto" formControlName="precio_min">
                    </div>
