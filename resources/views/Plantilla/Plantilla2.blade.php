    ...
    <form class="form-inline my-2 my-lg-0" id="buscar1"  action="buscar">
      ...
      <path fill-rule="evenodd" d="M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zM13 6.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0z"/>
           ...
           @canany(['isAdmin','isSecretaria'])
            ...
            @endcanany
            @can('view',App\Laboratorio::class)
          ...
          <li class="nav-item dropdown" id="cerrar">
            <button style="margin-left:7px;background: #43A047;" id="navbarDropdown" class="btn btn-secondary dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
