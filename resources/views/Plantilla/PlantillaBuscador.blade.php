...
<div class="nav-scroller bg-white shadow-sm" id="cinco" style="height:1550px; width: 300px;   background-image: linear-gradient(to bottom, #00cccc ,#00cccc ); position:absolute; top:-50px; ">
      <nav class="navbar navbar-expand-lg navbar-light bg-light"  id="" style="height:px; width: 300px;">
...
<header> 
    ...
    <nav class="navbar navbar-expand-lg" style="width: 1080px;
 position: absolute;
left: 300px;
top:px;
...
height: 80px;">
  ...
  <div class="collapse navbar-collapse" id="buscador" >
    <form class="form-inline my-2 my-lg-0" id="buscar1"  action="buscar">
      ...
      <!--Autenticación  -->
<div style="position:absolute; left:890px; top:px;">
...
<div class="dropdown" style="top:5px;left:-400px;">
...
<div >
       @can('isAdmin') <a  href="{{route('usuario.actualizar',Auth::user()->id)}}">@endcan<img class="logo" style="border-radius: 70%;left: 1140px;bottom:0.3em;  position:absolute; top: 15px;" src='/Imagenes/{{Auth::user()->imagen}}'   width="40px" height="40px"></a>
      </div>
</header>
<!-- Begin page content -->
  <!-- class="flex-shrink-0" -->
