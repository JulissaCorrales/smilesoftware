...
<div>
    ...
    <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0"    action="buscar">
      <div class="input-group">
        <input type="text" class="form-control"   name="buscarpor"  style="position:relative; width:400px;margin-left:1em;"placeholder="Buscar Paciente..." aria-label="Search" aria-describedby="basic-addon2">   <button   class="btn btn-primary" type="button" style="width:50px; height:40px;"> <svg width="1em" height="50px;" viewBox="0 0 16 16" class="bi bi-search" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
