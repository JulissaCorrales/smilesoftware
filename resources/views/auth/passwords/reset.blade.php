		...
		<div class="card">
            ...
            <form method="POST" action="{{ route('password.update') }}">
					...
					<div class="input-group form-group">
                        ...
                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"placeholder="Ingrese el Correo Electronico" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
            ...
            @error('password')
                  ...
                  @enderror
                    ...
                    <button type="submit" class="btn btn-primary" id="buton2">Restablecer Contraseña</button>
					</div>
				</form>
			</div>
