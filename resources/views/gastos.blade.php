...
<thead>
        ...
        @forelse($gastos as $gasto)
            ...
            <td>{{$gasto->monto}}</td>
            @can('update',$gasto)
            <td >  <a class="btn btn-warning "  data-toggle="modal" data-target="#modal-{{$gasto->id}}">
 ...
 <div class="modal fade" id="modal-{{$gasto->id}}" >
            <div class="modal-dialog" role="document">
                <div class="modal-content" >
                <div id="div1"class="modal-header" style="background-color:#293d3d; color:white;  height:100px;">
