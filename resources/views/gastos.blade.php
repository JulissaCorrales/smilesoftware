...
<html lang="en">
  ...
  <path d="M9.998 5.083 10 5a2 2 0 1 0-3.132 1.65 5.982 5.982 0 0 1 3.13-1.567z"/>
                        ...
                        <div id="divhijo1"><!-- div hijo1 -->
                            ...
                            <a type="button" class="btn " id="btnAgregarGasto"  data-toggle="modal" data-target="#creategasto" style="background-color:#28a4a4; color:#c1f0f0; position: relative;float:right">
