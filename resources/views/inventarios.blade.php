...
<div class="container" id="dd">
   ...
   <h1 align="center" id="titulo">Inventarios de la Clinica</h1> 
  @if ($errors->any())
...
<button type="button" id="btnagregar" class="btn btn-secondary"  class="btn btn-primary" data-toggle="modal" data-target="#nuevoinventario">
...
<a type="button" class="btn btn-dark " id="btndescarga"  href="{{route('descargarPDFInventarios')}}"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cloud-download" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<table id="datatable" class="table table-striped table-success">
...
$(document).ready( function () {
    ...
    language: {
        ...
        "infoEmpty": "Mostrando 0 to 0 of 0 Inventarios",
        "infoFiltered": "(Filtrado de _MAX_ total Inventarios)",
        "infoPostFix": "",
        "thousands": ",",
