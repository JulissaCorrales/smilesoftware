...
<button id="btndescarga" href="{{route('descargarPDFInventarios')}}" class="btn btn-dark "><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cloud-download" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
