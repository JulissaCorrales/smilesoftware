...
<html lang="en">
 ...
 <div class="card mb-3"> 
  ...
  <path d="M7 5.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm-1.496-.854a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0zM7 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm-1.496-.854a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0z"/>
                ...
                <p>En esta Sección se muestra los Inventarios Existentes en la actualidad y en seguridad, también se podra editar datos, crear un nuevos Inventarios, borrar los inventarios existentes y descargar el archivo el archivo con todos los Inventarios.</p>
          </div>
          <!-- -->
          ...
          <div style="width:;">
                ...
                @can('create',App\Inventario::class)
                    <button type="button" id="btnagregar"  class="btn btn-info " data-toggle="modal" data-target="#nuevoinventario" style="position:absolute; left:900px; margin: 10px;" >
