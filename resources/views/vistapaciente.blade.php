...
<a type="button"style="background-color:#70db70; color:#666699; position: absolute;
  left: 850px;
  top:  140px;"  class="btn btn-danger" href="{{route('descargarPDFPacientes')}}"><svg width="25" height="25" viewBox="0 0 16 16" class="bi bi-cloud-download" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<div>@can('create', App\Paciente::class)
  ...
  left: 790px;
  top:  140px;   " class="btn btn-danger"  data-toggle="modal" data-target="#create"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
