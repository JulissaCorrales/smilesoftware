...
<body id="page-top">
        ...
        <div class="card mb-3">
          <div class="card-header">
           <h4><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-badge-fill" viewBox="0 0 16 16">
            ...
            <div>
            <a type="button"style="background-color:#ffb037; color:#151515; position: relative;float:right;"  class="btn" href="{{route('descargarPDFPacientes')}}"><svg width="25" height="25" viewBox="0 0 16 16" class="bi bi-cloud-download" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div >
            <button type="button"  class="btn btn-outline-info" data-toggle="modal" data-target="#Crearpaciente" style=" position: relative; float:right;margin-top:-4em;margin-right:-12em;width: 190px;" >
