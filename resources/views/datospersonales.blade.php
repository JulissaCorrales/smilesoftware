     ...
     <div id="wrapper">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
                    @canany(['isAdmin','isOdontologo'])
                    <div class="text-center"  style="width: 14rem; background-color: #d3e0ea; margin: 0px; 15px; 15px; 10px;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-text" viewBox="0 0 16 16">
