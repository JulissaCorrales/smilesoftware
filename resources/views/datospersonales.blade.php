     ...
     <div class="list-group" id="carbdos">
          ...
          <div id="personal">
            ...
            <ul class="list-group-item" id="lista1">
              <!--  -->
              <li class="btn btn-light"><a class="btn btn-light" id="" href="" ><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-camera-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
