        ...
        <!--cita --><div class="row" >
                      <div class="col-md-10" >
                        ...
                        @can('create',App\Cita::class)
                                    <button  type="button" style="position:relative; margin-top:3.4em;"class="btn btn-outline-info form-control" id="darcita" style="background-color:#1687a7; color:white; "  data-toggle="modal" data-target="#create" >  
