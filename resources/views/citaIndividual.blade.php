...
<div class="card">
    <div class="card-header">
            ...
            @endcan
                            ...
                            <!-- descargar -->
                    @can('DescargarCitasPorPaciente',App\Cita::class)         
                    <a href="{{route('descargarPDFCitasindividuales',['id'=>$pacientes->id])}}" style="background-color:#1687a7; color:white;  position: relative;float:right;
            width:150px; "class="dropdown-item"><svg width="25" height="25" viewBox="0 0 16 16" class="bi bi-cloud-download" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
