...
<!--  -->
    ...
    <div class="container" id="padre">
        ...
        <a href="{{route('descargarPDFCitasindividuales',['id'=>$pacientes->id])}}"class="dropdown-item"><svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-cloud-download" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
