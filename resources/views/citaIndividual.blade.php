...
<div class="card">
    <div class="card-header">
            ...
            <p>En esta sección se muestra las citas registrados y también se podrá agendar nuevas citas</p>
                    ...
                    @forelse ($pacientes->citas as $tag) 
                        <tr>
                            ...
                            <td>
                                ...
                                <button  style="background-color:green;" class="btn btn-secondary" href="{{route('citaindividual.editar',['id'=>$pacientes->id,'citaid'=>$tag->id])}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
