...
Route::get('roles','RolController@Roles') ->name('roles.ver')->middleware('role:admin');
...
route::get('{id}/pdfcitasindividualesimpresion','PDFController@PDFCitaindividual')->name('descargarPDFCitasindividuales');
